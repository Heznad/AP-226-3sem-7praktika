...
namespace Automobile
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // »нициализаци€ калькул€тора расхода топлива
            IFuelConsumptionCalculator fuelConsumptionCalculator = new
StandardFuelConsumptionCalculator();

            // »нициализаци€ менеджера пассажиров
            IPassengerManager passengerManager = new PassengerManager();

            // »нициализаци€ класса Automobile
            Automobile automobile = new Automobile(fuelConsumptionCalculator,
passengerManager);

            Console.WriteLine($"Maker: {automobile.Maker}, Model: {automobile.Model}, Year: { automobile.Year}");

            // “естирование расчета рассто€ни€ до опустошени€ топливного бака
            ...
            // “естирование добавлени€ и удалени€ пассажиров
    ...
    {
        // ќставл€ем только свойства, св€занные с данными автомобил€
        ...
        public Automobile(IFuelConsumptionCalculator calculator, IPassengerManager
manager)
        {
        ...
        {
            return fuelConsumptionCalculator.CalculateDistanceToEmpty(FuelVolume,
EnginePower);
        }
